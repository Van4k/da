...
url_version := "https://raw.githubusercontent.com/Van4k/da/main/lecObn/lec.ahk" ; Ссылка на файл проверки обновлений (там указываю версию скрипта)
script_version := 1 ; Версия вашего текущего скрипта.
...
#IfWinActive MTA: Province
	pg1:
		...
		Gui, 1: Font, S12,
		Gui, 1: Add, Text, x2 y180 w290 h20 , Субо21212рдинация. 
